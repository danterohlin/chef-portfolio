    ...
    >
      <div className="relative">
        ...
        <div className="absolute bottom-20 left-2/4 transform -translate-x-2/4 -translate-y-2/4">
          ...
          >
            <h1 className="text-white mb-4 cursor-pointer bg-green-400 m-auto whitespace-nowrap poppins text-center leading-none leading-snug text-xl sm:text-xl bg-opacity-80 px-12 py-4 hover:bg-opacity-60 transition duration-500 hover:bg-black hover:text-white hover:scale-105 transform">
              About Me
            </h1>
          </LinkScroll>
        </div>
