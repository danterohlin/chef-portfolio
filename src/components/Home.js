		...
		>
			<div className="relative">
				...
				<div className="absolute top-2/4 left-2/4 transform -translate-x-2/4 -translate-x-2/4">
					...
					>
						Experienced and passionate chef <br /> with experience in various
						restaurants <br /> striving to serve the best food possible
					</h2>
				</div>
				<div className="absolute bottom-20 left-2/4 transform -translate-x-2/4 -translate-y-2/4">
					...
					>
						<h1 className="text-white mb-4 cursor-pointer bg-green-400 m-auto whitespace-nowrap poppins text-center leading-none leading-snug text-lg sm:text-lg bg-opacity-80 px-12 py-2 hover:bg-opacity-60 transition duration-500 hover:bg-green-400 hover:text-white hover:scale-105 transform">
							About Me
						</h1>
					</LinkScroll>
				</div>
					...
					<div className="bg-black text-yellow-50 xl:w-3/5 bg-opacity-70 lg:p-6">
						...
						<p className="mx-4">
							...
							<div className="flex items-center">
								...
								Bringing forth an in depth knowledge of flavors and food relationships,
								resulting in mouth watering dishes and attractive menus.
							</div>
						</p>
						<div className="pt-6 m-auto">
							<LinkScroll to="recipies" smooth={true} duration={1000} offset={0}>
								<h1 className="text-white w-5/6 mb-4 cursor-pointer text-green-200 hover:text-black m-auto whitespace-nowrap poppins text-center leading-none leading-snug text-xl sm:text-xl bg-opacity-80 px-12 py-2 hover:bg-opacity-100 transition duration-500 hover:bg-green-400 hover:scale-105 transform">
									Show me more
								</h1>
							</LinkScroll>
						</div>
