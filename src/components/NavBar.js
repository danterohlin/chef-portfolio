...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {toggleMenu && (
        <div className="burger-menu justify-center pb-5 items-center w-full right-0 top-20 w-1/3 bg-white flex z-10">
          <NavLink
            to="/post"
            activeClassName="scale-125 font-bold text-yellow-500"
